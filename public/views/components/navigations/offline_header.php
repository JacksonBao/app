...
<head>
  <title><?php echo @$this->pageTitle ?: 'Welcome to thanos API'; ?></title>
  ...
  <!-- <script type="module" rel="noreferrer" src="https://unpkg.com/ionicons@5.0.0/dist/ionicons/ionicons.esm.js"></script> -->
  <!-- JS PLUGIN -->
</head>
      ...
      <div class="d-flex flex-wrap w-100 py-3 ">
        ...
        <div class="p-0 col-2 col-md-8 col-lg-8 d-none border-0 d-md-block">
          <div class="d-flex flex-wrap justify-content-end w-100 ">
            ...
            <div class="mx-1 text-hv-third p-2 align-self-center _cont_36 _text_12">
              <div class="align-self-center float-left">
                <b class=""><a href="/#signup">Sing up</a></b>
              </div>
            </div>
    ...
    <nav id="sidebar" class="scroll-sm bg-light">
      ...
      <div class="sideBarCont">
        <ul class="list-unstyled components">
          ...
          <li><a href="/#login"><i class="fa fa-user font-weight-light"></i> Login</a></li>
          <li><a href="/#signup"><i class="fa fa-user font-weight-light"></i> Sign up</a></li>
