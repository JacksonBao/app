...
{
    public function addCookie(string $name, $value, string $expires = '1 day', $path = '/', string $domain = 'njofa.dv', bool $secure = true, bool $http = true)
    {
        $orgVal = $value;
    ...
    public function deleteCookie(string $name, $domain = 'njofa.dv')
    {
